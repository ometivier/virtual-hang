...
This web app allows you to play a virtual hang in your browser. It uses the Web Audio API to load audio files into a buffer and trigger them when a user hovers over the tines.
